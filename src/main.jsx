...
const asset = (path) => `/generated-website-images/${path}`;
...
const sections = [
  ...
  },
  {
    ...
    links: [
      {
        label: 'Frog Game',
        href: '/assets/linked-pages/frog-game.html',
      },
      {
        label: 'Declension Chart',
        href: '/assets/linked-pages/declension-architect.html',
      },
      {
        label: 'Declension Racer',
        href: '/assets/linked-pages/declension-chart-game.html',
      },
      {
        label: 'Verb ID',
        href: '/assets/linked-pages/verb-id-hard-mode.html',
      },
      {
        label: 'Case ID',
        href: '/assets/linked-pages/noun-id-game.html',
      },
    ],
  },
  {
    ...
    links: [
      {
        label: 'Game of Life',
        href: '/assets/linked-pages/conways-game-of-life.html',
      },
      {
        label: 'Double Pendulum',
        href: '/assets/linked-pages/double-pendulum.html',
      },
      {
        label: 'Plinko',
        href: '/assets/linked-pages/plinko.html',
      },
      {
        label: 'Stoicism',
  ...
  },
  {
    ...
    links: [
      {
        label: 'Commentary',
        href: '/assets/linked-pages/pliny-with-commentary.pdf',
      },
      {
        label: 'Word List',
        href: '/assets/linked-pages/ap-vocabulary-papyrus-tabs.html',
      },
    ],
  },
  {
    ...
    links: [
      ...
      {
        label: 'Flashcards',
        href: '/assets/linked-pages/latin-flash-cards.html',
      },
    ],
  },
  {
